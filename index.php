...
<head>
    ...
    <meta name="description" content="Votre partenaire de confiance pour des travaux de plaquisterie, plâtrerie et stafferie à Nice et dans les Alpes-Maritimes. Qualité, réactivité et mobilité garanties. Contactez-nous dès aujourd'hui pour concrétiser vos projets." />
    <title>LOUCORP</title>
    <meta name="robots" content="index, follow" />
    <meta name="keywords" content="plaquisterie, plâtrerie, stafferie, Nice, Alpes-Maritimes, rénovation, construction, devis rapide, travail de qualité" />
...
<body class="">
                    ...
                    <form method="POST" action="">
                        <div class="d-flex mb-3">
                            <div class="form-group col-md-6 pe-1">
                                ...
                                <input type="text" placeholder="Lou" class="form-control" id="prenom" name="prenom" required />
                            </div>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="form-group col-md-6 ps-1">
                                ...
                                <input type="number" placeholder="en m²" class="form-control" id="superficie" name="superficie" required />
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <label for="message">Message :</label>
                            <textarea class="form-control" placeholder="Détaillez votre demande au maximum" id="message" name="message" rows="4" required></textarea>
                        </div>
                        <div class="text-center">
    ...
    <footer class="bg-light mt-2">
        <div class="container px-4 px-lg-5">
            ...
            <div class="small text-center text-muted "> Site réalisé par <a href="https://devwebconcept.com" class="text-muted">DevWebConcept</a></div>
        </div>
    </footer>
